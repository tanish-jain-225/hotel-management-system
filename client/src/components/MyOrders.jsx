...
import { ArrowLeft, Clock, CreditCard, Hash, Calendar, Package, RefreshCw, CheckCircle2 } from "lucide-react";
    ...
    >
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4">
        <div>
          ...
          <h2 className="text-4xl font-black text-gray-900 tracking-tight">Track <span className="text-blue-600">My Orders</span></h2>
        </div>
        ...
        <motion.button
          ...
          disabled={refreshing}
          className="flex items-center gap-2 px-5 py-2.5 bg-blue-50 text-blue-600 border border-blue-100 rounded-xl font-bold hover:bg-blue-100 transition-colors cursor-pointer disabled:opacity-50"
        >
      ...
      <AnimatePresence mode="popLayout">
        {orders.length === 0 ? (
          ...
          >
            ...
            <p className="text-xl text-gray-400 font-medium mb-4">You haven't placed any orders in this session yet.</p>
            <button
              onClick={() => navigate("/")}
            ...
            {orders.map((order, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="bg-blue-600 text-white p-6 flex flex-col justify-center items-center md:w-44 text-center">
                  ...
                  <div className="p-6 sm:p-8 grow grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {/* Customer & Delivery */}
